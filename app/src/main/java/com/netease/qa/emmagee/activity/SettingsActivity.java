...
public class SettingsActivity extends Activity {
    ...
    private static final String LOG_TAG = Constants.LOG_PREFIX + SettingsActivity.class.getSimpleName();
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        wakeLockItem.setOnClickListener(new OnClickListener() {
            ...
            public void onClick(View arg0) {
                ...
                preferences.edit().putBoolean(Settings.KEY_WACK_LOCK, !isChecked).apply();
